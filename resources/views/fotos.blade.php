...
<body>
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img class="img2" src="https://www.incasperu.com/wp-content/uploads/2020/02/peru-en-15-dias-conocer.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <center>
          <h5>Lago titicaca</h5>
    ...
    <div class="carousel-item">
      <img class="img3" src="https://diariocorreo.pe/resizer/sVq8votl8FSImkHa7M-u7aGmeXo=/580x330/smart/filters:format(jpeg):quality(75)/arc-anglerfish-arc2-prod-elcomercio.s3.amazonaws.com/public/7Q3AKAPE6BEBZK22SNOTROSL2E.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <center>
           <h5>Huascaran</h5>
